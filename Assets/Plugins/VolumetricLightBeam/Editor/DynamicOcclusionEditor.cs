...
[CustomEditor(typeof(DynamicOcclusion))]
    ...
    public class DynamicOcclusionEditor : EditorCommon
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(minOccluderArea, new GUIContent("Min Occluder Area",
                                                                          "Minimum 'area' of the collider to become an occluder.\nColliders smaller than this value will not block the beam."));
            EditorGUILayout.PropertyField(waitFrameCount, new GUIContent("Wait frame count",
            ...
            EditorGUILayout.PropertyField(planeAlignment, new GUIContent("Alignment",
